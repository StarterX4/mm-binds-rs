...
pub mod root {
    ...
    pub mod SourceHook {
        ...
        #[derive(Debug)]
        pub struct String {
            pub v: *mut ::core::ffi::c_char,
            pub a_size: usize,
        }
        unsafe extern "C" {
            #[link_name = "\u{1}_ZN10SourceHook6String4nposE"]
            pub static String_npos: usize;
        }
        #[allow(clippy::unnecessary_operation, clippy::identity_op)]
        const _: () = {
            ["Size of String"][::core::mem::size_of::<String>() - 16usize];
            ["Alignment of String"][::core::mem::align_of::<String>() - 8usize];
            ["Offset of field: String::v"][::core::mem::offset_of!(String, v) - 0usize];
            ["Offset of field: String::a_size"][::core::mem::offset_of!(String, a_size) - 8usize];
        };
    }
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
