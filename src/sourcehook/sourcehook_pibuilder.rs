...
pub mod root {
    ...
    pub mod SourceHook {
        ...
        #[repr(C)]
        #[derive(Debug)]
        pub struct CProtoInfoBuilder {
            pub m_PI: root::SourceHook::ProtoInfo,
            pub m_Params: root::SourceHook::CVector<root::SourceHook::PassInfo>,
            pub m_Params2: root::SourceHook::CVector<root::SourceHook::PassInfo_V2Info>,
        }
        #[allow(clippy::unnecessary_operation, clippy::identity_op)]
        const _: () = {
            ["Size of CProtoInfoBuilder"][::core::mem::size_of::<CProtoInfoBuilder>() - 128usize];
            ["Alignment of CProtoInfoBuilder"]
                [::core::mem::align_of::<CProtoInfoBuilder>() - 8usize];
            ["Offset of field: CProtoInfoBuilder::m_PI"]
                [::core::mem::offset_of!(CProtoInfoBuilder, m_PI) - 0usize];
            ["Offset of field: CProtoInfoBuilder::m_Params"]
                [::core::mem::offset_of!(CProtoInfoBuilder, m_Params) - 80usize];
            ["Offset of field: CProtoInfoBuilder::m_Params2"]
                [::core::mem::offset_of!(CProtoInfoBuilder, m_Params2) - 104usize];
        };
    }
    unsafe extern "C" {
        pub fn memcpy(
    ...
    #[allow(clippy::unnecessary_operation, clippy::identity_op)]
    const _: () = {
        ["Size of template specialization: CVector_open0_PassInfo_close0"][::core::mem::size_of::<
            root::SourceHook::CVector<root::SourceHook::PassInfo>,
        >() - 24usize];
        ["Align of template specialization: CVector_open0_PassInfo_close0"][::core::mem::align_of::<
            root::SourceHook::CVector<root::SourceHook::PassInfo>,
        >() - 8usize];
    };
    #[allow(clippy::unnecessary_operation, clippy::identity_op)]
    const _: () = {
        ["Size of template specialization: CVector_open0_PassInfo_V2Info_close0"]
            [::core::mem::size_of::<root::SourceHook::CVector<root::SourceHook::PassInfo_V2Info>>(
            ) - 24usize];
        ["Align of template specialization: CVector_open0_PassInfo_V2Info_close0"]
            [::core::mem::align_of::<root::SourceHook::CVector<root::SourceHook::PassInfo_V2Info>>(
            ) - 8usize];
    };
}
