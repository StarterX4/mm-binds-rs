...
pub mod root {
    ...
    pub mod SourceMM {
        ...
        pub const SourceMM_Pl_BadLoad: root::SourceMM::_bindgen_ty_1 = 0;
        pub const SourceMM_Pl_Console: root::SourceMM::_bindgen_ty_1 = -1;
        pub const SourceMM_Pl_File: root::SourceMM::_bindgen_ty_1 = -2;
        pub const SourceMM_Pl_MinId: root::SourceMM::_bindgen_ty_1 = 1;
        #[doc = " @brief Load sources"]
        pub type _bindgen_ty_1 = ::core::ffi::c_int;
        pub const Pl_Status_Pl_NotFound: root::SourceMM::Pl_Status = -4;
        pub const Pl_Status_Pl_Error: root::SourceMM::Pl_Status = -3;
        pub const Pl_Status_Pl_Refused: root::SourceMM::Pl_Status = -2;
        pub const Pl_Status_Pl_Paused: root::SourceMM::Pl_Status = -1;
        pub const Pl_Status_Pl_Running: root::SourceMM::Pl_Status = 0;
        #[doc = " @brief Status of a plugin at runtime"]
        pub type Pl_Status = ::core::ffi::c_int;
        #[repr(C)]
        pub struct ISmmPluginManager__bindgen_vtable(::core::ffi::c_void);
        #[doc = " @brief Programmatic management of the \"loaded plugin\" list."]
        #[repr(C)]
        #[derive(Debug, Copy, Clone)]
        pub struct ISmmPluginManager {
            pub vtable_: *const ISmmPluginManager__bindgen_vtable,
        }
        #[allow(clippy::unnecessary_operation, clippy::identity_op)]
        const _: () = {
            ["Size of ISmmPluginManager"][::core::mem::size_of::<ISmmPluginManager>() - 8usize];
            ["Alignment of ISmmPluginManager"]
                [::core::mem::align_of::<ISmmPluginManager>() - 8usize];
        };
    }
