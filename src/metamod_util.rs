...
pub mod root {
    ...
    pub const BINARY_EXT: &[u8; 4] = b".so\0";
    unsafe extern "C" {
    ...
    unsafe extern "C" {
        #[doc = " @brief Returns a pointer to the extension in a file name."]
        #[link_name = "\u{1}_Z17UTIL_GetExtensionPKc"]
        pub fn UTIL_GetExtension(file: *const ::core::ffi::c_char) -> *const ::core::ffi::c_char;
    }
    unsafe extern "C" {
        #[doc = " @brief Removes whitespace characters from left side of string."]
        #[link_name = "\u{1}_Z13UTIL_TrimLeftPc"]
        pub fn UTIL_TrimLeft(buffer: *mut ::core::ffi::c_char);
    }
    unsafe extern "C" {
        #[doc = " @brief Removes whitespace characters from right side of string."]
        #[link_name = "\u{1}_Z14UTIL_TrimRightPc"]
        pub fn UTIL_TrimRight(buffer: *mut ::core::ffi::c_char);
    }
    unsafe extern "C" {
        #[doc = " @brief Compares two file paths."]
        #[link_name = "\u{1}_Z12UTIL_PathCmpPKcS0_"]
        pub fn UTIL_PathCmp(
    ...
    unsafe extern "C" {
        #[doc = " @brief Same as snprintf except that it ensures the string buffer is null terminated."]
        #[link_name = "\u{1}_Z11UTIL_FormatPcmPKcz"]
        pub fn UTIL_Format(
            buffer: *mut ::core::ffi::c_char,
            maxlength: usize,
    ...
    unsafe extern "C" {
        #[doc = " @brief Same as vsnprintf except that it ensures the string buffer is null terminated."]
        #[link_name = "\u{1}_Z15UTIL_FormatArgsPcmPKcP13__va_list_tag"]
        pub fn UTIL_FormatArgs(
            buffer: *mut ::core::ffi::c_char,
            maxlength: usize,
            fmt: *const ::core::ffi::c_char,
            params: *mut root::__va_list_tag,
        ) -> usize;
    }
    unsafe extern "C" {
        #[doc = " @brief Forms a relative path given two absolute paths.\n\n @param buffer\t\tBuffer to store relative path in.\n @param maxlength\t\tMaximum length of the output buffer.\n @param relTo\t\t\tDestination folder to use as a working directory.\n\t\t\t\t\t\tFinal folder name should not be pathchar-terminated.\n @param relFrom\t\tSource file or folder to use as a target.\n @return\t\t\t\tTrue on success, false on failure."]
        #[link_name = "\u{1}_Z13UTIL_RelatizePcmPKcS1_"]
        pub fn UTIL_Relatize(
            buffer: *mut ::core::ffi::c_char,
            maxlength: usize,
            relTo: *const ::core::ffi::c_char,
            relFrom: *const ::core::ffi::c_char,
        ) -> bool;
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_Z14UTIL_Relatize2PcmPKcS1_"]
        pub fn UTIL_Relatize2(
            buffer: *mut ::core::ffi::c_char,
            maxlength: usize,
            relTo: *const ::core::ffi::c_char,
            relFrom: *const ::core::ffi::c_char,
