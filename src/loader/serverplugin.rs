...
pub mod root {
    ...
    unsafe extern "C" {
        #[link_name = "\u{1}_Z18mm_GetVspCallbacksj"]
        pub fn mm_GetVspCallbacks(version: ::core::ffi::c_uint) -> *mut ::core::ffi::c_void;
    }
    unsafe extern "C" {
        pub static mut vsp_bridge: *mut root::IVspBridge;
    }
}
