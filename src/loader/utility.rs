...
pub mod root {
    ...
    unsafe extern "C" {
        #[link_name = "\u{1}_Z9mm_FormatPcmPKcz"]
        pub fn mm_Format(
    ...
    unsafe extern "C" {
        #[link_name = "\u{1}_Z14mm_LoadLibraryPKcPcm"]
        pub fn mm_LoadLibrary(
    ...
    unsafe extern "C" {
        #[link_name = "\u{1}_Z16mm_GetLibAddressPvPKc"]
        pub fn mm_GetLibAddress(
            lib: *mut ::core::ffi::c_void,
            name: *const ::core::ffi::c_char,
        ) -> *mut ::core::ffi::c_void;
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_Z16mm_UnloadLibraryPv"]
        pub fn mm_UnloadLibrary(lib: *mut ::core::ffi::c_void);
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_Z14mm_ResolvePathPKcPcmb"]
        pub fn mm_ResolvePath(
            path: *const ::core::ffi::c_char,
            buffer: *mut ::core::ffi::c_char,
            maxlength: usize,
            bSource2: bool,
    ...
    unsafe extern "C" {
        #[link_name = "\u{1}_Z13mm_PathFormatPcmPKcz"]
        pub fn mm_PathFormat(
            buffer: *mut ::core::ffi::c_char,
            len: usize,
            fmt: *const ::core::ffi::c_char,
            ...
    ...
    unsafe extern "C" {
        #[link_name = "\u{1}_Z11mm_TrimLeftPc"]
        pub fn mm_TrimLeft(buffer: *mut ::core::ffi::c_char);
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_Z12mm_TrimRightPc"]
        pub fn mm_TrimRight(buffer: *mut ::core::ffi::c_char);
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_Z15mm_TrimCommentsPc"]
        pub fn mm_TrimComments(buffer: *mut ::core::ffi::c_char);
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_Z11mm_KeySplitPKcPcmS1_m"]
        pub fn mm_KeySplit(
            str_: *const ::core::ffi::c_char,
            buf1: *mut ::core::ffi::c_char,
            len1: usize,
            buf2: *mut ::core::ffi::c_char,
            len2: usize,
        );
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_Z10mm_PathCmpPKcS0_"]
        pub fn mm_PathCmp(
    ...
    unsafe extern "C" {
        #[link_name = "\u{1}_Z19mm_GetFileOfAddressPvPcm"]
        pub fn mm_GetFileOfAddress(
    ...
    unsafe extern "C" {
        #[link_name = "\u{1}_Z14mm_FindPatternPKvPKcm"]
        pub fn mm_FindPattern(
            libPtr: *const ::core::ffi::c_void,
            pattern: *const ::core::ffi::c_char,
            len: usize,
        ) -> *mut ::core::ffi::c_void;
    }
    unsafe extern "C" {
        #[link_name = "\u{1}_Z21mm_GetCommandArgumentPKcPcm"]
        pub fn mm_GetCommandArgument(
