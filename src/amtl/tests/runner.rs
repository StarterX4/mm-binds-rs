...
pub mod root {
    ...
    pub mod ke {
        ...
        #[repr(C)]
        #[derive(Debug, Copy, Clone)]
        pub struct FallibleMalloc {
            pub shouldOutOfMemory_: bool,
            pub ooms_: usize,
            pub overflows_: usize,
        }
        #[allow(clippy::unnecessary_operation, clippy::identity_op)]
        const _: () = {
            ["Size of FallibleMalloc"][::core::mem::size_of::<FallibleMalloc>() - 24usize];
            ["Alignment of FallibleMalloc"][::core::mem::align_of::<FallibleMalloc>() - 8usize];
            ["Offset of field: FallibleMalloc::shouldOutOfMemory_"]
                [::core::mem::offset_of!(FallibleMalloc, shouldOutOfMemory_) - 0usize];
            ["Offset of field: FallibleMalloc::ooms_"]
                [::core::mem::offset_of!(FallibleMalloc, ooms_) - 8usize];
            ["Offset of field: FallibleMalloc::overflows_"]
                [::core::mem::offset_of!(FallibleMalloc, overflows_) - 16usize];
        };
    }
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
