...
pub mod root {
    ...
    pub mod ke {
        ...
        #[repr(C)]
        #[derive(Debug)]
        pub struct HashMap<AllocPolicy> {
            pub _phantom_0: ::core::marker::PhantomData<::core::cell::UnsafeCell<AllocPolicy>>,
            pub _base: AllocPolicy,
            pub table_: root::ke::HashMap_Internal<AllocPolicy>,
        }
        #[repr(C)]
        #[derive(Debug, Copy, Clone)]
        pub struct HashMap_Entry<K, V> {
        ...
        #[repr(C)]
        #[derive(Debug, Copy, Clone)]
        pub struct HashMap_Policy {
            pub _address: u8,
        }
        pub type HashMap_Policy_Payload<K, V> = root::ke::HashMap_Entry<K, V>;
        pub type HashMap_Internal<AllocPolicy> = root::ke::HashTable<AllocPolicy>;
        pub type HashMap_Result<AllocPolicy> = root::ke::HashMap_Internal<AllocPolicy>;
        pub type HashMap_Insert<AllocPolicy> = root::ke::HashMap_Internal<AllocPolicy>;
        pub type HashMap_iterator<AllocPolicy> = root::ke::HashMap_Internal<AllocPolicy>;
        #[repr(C)]
        #[derive(Debug, Copy, Clone)]
