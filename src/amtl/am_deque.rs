...
pub mod root {
    ...
    pub mod std {
        ...
        pub type _Deque_iterator__Elt_pointer = root::std::__ptr_rebind;
        pub type _Deque_iterator__Map_pointer = root::std::__ptr_rebind;
        ...
        pub type _Deque_base__Tp_alloc_type = root::__BindgenOpaqueArray<u8, 0usize>;
        pub type _Deque_base__Alloc_traits = root::__gnu_cxx::__alloc_traits;
        pub type _Deque_base__Ptr = root::__BindgenOpaqueArray<u8, 0usize>;
        pub type _Deque_base__Ptr_const = root::__BindgenOpaqueArray<u8, 0usize>;
        pub type _Deque_base__Map_alloc_type = root::__BindgenOpaqueArray<u8, 0usize>;
        ...
        pub type _Deque_base__Map_pointer = root::__BindgenOpaqueArray<u8, 0usize>;
        #[repr(C)]
        pub struct _Deque_base__Deque_impl_data {
        ...
        pub struct _Deque_base__Deque_impl {
            pub _base_1: root::std::_Deque_base__Deque_impl_data,
        }
